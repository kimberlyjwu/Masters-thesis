...
for (i in 1:4) {
  filename = paste0(path, "A_KM_", i, ".csv")
...
for (i in 1:4) {
  ...
  assign(km_name, transform(get(km_name), position = paste0('k', i), size = 'km', method = 'A'))

  assign(points_km_name, transform(get(points_km_name), position = paste0('k', i), size = 'km', method = 'A'))
}
```
...
```{r}
#library(openxlsx)
#write.xlsx(km_mse, file = "/Final/KM/A/A_KM.xlsx")
#write.xlsx(km_points, file = "/Final/KM/A/A_KM_points.xlsx")
```
...
```{r}
#library(openxlsx)
#write.xlsx(km_dist_result, file = "/Final/KM/A/A_KM_dist_result.xlsx")
#write.xlsx(km_points_result, file = "/Final/KM/A/A_KM_points_result.xlsx")
```
