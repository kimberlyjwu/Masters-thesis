...
for (i in 1:4) {
  filename <- paste0(path, "A_M100_", i, ".csv")
...
for (i in 1:4) {
  ...
  assign(name, transform(get(name), position = paste0('h', i), size = 'm100', method = 'A'))

  assign(points_name, transform(get(points_name), position = paste0('h', i), size = 'm100', method = 'A'))
}
```
...
```{r}
#library(openxlsx)
#write.xlsx(m100_mse, file = "/Final/M100/A/A_M100.xlsx")
#write.xlsx(m100_points, file = "/Final/M100/A/A_M100_points.xlsx")
```
...
```{r}
#library(openxlsx)
#write.xlsx(m100_dist_result, file = "/Final/M100/A/A_M100_dist_result.xlsx")
#write.xlsx(m100_points_result, file = "/Final/M100/A/A_M100_points_result.xlsx")
```
