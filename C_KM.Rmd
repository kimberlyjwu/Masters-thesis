...
for (i in 1:4) {
  ...
  assign(km_name, transform(get(km_name), position = paste0('k', i), size = 'km', method = 'C'))

  assign(points_km_name, transform(get(points_km_name), position = paste0('k', i), size = 'km', method = 'C'))
}
```
...
```{r}
#library(openxlsx)
#write.xlsx(km_mse, file = "/Final/KM/C/C_KM.xlsx")
#write.xlsx(km_points, file = "/Final/KM/C/C_KM_points.xlsx")
```
...
```{r}
#library(openxlsx)
#write.xlsx(km_dist_result, file = "/Final/KM/C/C_KM_dist_result.xlsx")
#write.xlsx(km_points_result, file = "/Final/KM/C/C_KM_points_result.xlsx")
```
