...
for (i in 1:4) {
  ...
  assign(name, transform(get(name), position = paste0('f', i), size = 'm500', method = 'C'))

  assign(points_name, transform(get(points_name), position = paste0('f', i), size = 'm500', method = 'C'))
}
```
...
```{r}
#library(openxlsx)
#write.xlsx(m500_mse, file = "/Final/M500/C/C_M500.xlsx")
#write.xlsx(m500_points, file = "/Final/M500/C/C_M500_points.xlsx")
```
...
```{r}
#library(openxlsx)
#write.xlsx(m500_dist_result, file = "/Final/M500/C/C_M500_dist_result.xlsx")
#write.xlsx(m500_points_result, file = "/Final/M500/C/C_M500_points_result.xlsx")
```
