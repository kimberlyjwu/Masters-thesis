...
for (i in 1:4) {
  df_name =  paste0("df", i)
  df_data = get(df_name)
  modified_df = points_three(df_data)
...
for (i in 1:4) {
  ...
  assign(name, transform(get(name), position = paste0('h', i), size = 'm100', method = 'B'))

  assign(points_name, transform(get(points_name), position = paste0('h', i), size = 'm100', method = 'B'))
}
```
...
```{r}
#library(openxlsx)
#write.xlsx(m100_mse, file = "/Final/M100/B/B_M100.xlsx")
#write.xlsx(m100_points, file = "/Final/M100/B/B_M100_points.xlsx")
```
...
```{r}
#library(openxlsx)
#write.xlsx(m100_dist_result, file = "/Final/M100/B/B_M100_dist_result.xlsx")
#write.xlsx(m100_points_result, file = "/Final/M100/B/B_M100_points_result.xlsx")
```
